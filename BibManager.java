...
class BibManager {
    ...
    private TreeMap<String, paper> refMap = new TreeMap<String, paper>();

    // List of the source_id in Long, generated from refMap	   //
...
/////////////////////////////////////////////////////////////////////////////////
	...
	//First path
	// it puts all the citations found into the refMap with a key
	...
	while( matcher.find( ) ) {
		...
		String key = getKeyString(p);
		//String key = (String)( p.getAuthors().get(0) + refNumbers[i] );
		refMap.put(key, p);
	    }
	}

	//Generate the refList from refMap
	ArrayList<paper> al = new ArrayList<paper>(refMap.values());
